...
Title:Inheritance
Question:Write the program display saving account without changing the current account using inheritance
**/
...
void  disp_details(String name , int age , String gender  , int limit )  // method for the child class Saving_Account
{
